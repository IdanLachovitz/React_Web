      ...
      >
        {genres.map(genre => (
          <div
            ...
            className="relative h-[340px] w-[225px] rounded-3xl overflow-hidden group cursor-pointer border border-black transition-all duration-500 hover:scale-[1.02] hover:shadow-[0_0_50px_-10px_rgba(147,51,234,0.5)] hover:border-purple-600/50 snap-start shrink-0"
          >
